...
public class TemperatureDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "cgtemperature10");
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "10.0.0.65:9092,10.0.0.66:9092");
        ...
        max.foreach(new ForeachAction<Windowed<String>, String>() {
